...
I can maybe… _maybe_ understand the mass exodus from Houston going on right now, but the long lines, messy traffic, and run on bread and bottled water I saw as I stopped in at the grocery store this morning, in AUSTIN, is just downright obnoxious.
...
And if it IS the End of the World? Well. You may as well [party like there’s no tomorrow](http://davidnunezdev.wpengine.com/node/651).
